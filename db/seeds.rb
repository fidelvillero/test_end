...
#user.save
user = User.create!( :user_id => 4 , email: "admin1708@hotmail.com", :password => "1234567",  :password_confirmation => "1234567", :role => 'Admin', :name => 'fidel',  :EPS => 'Saludcoop', :address => 'Kr 6 # 16 - 22')
#user.save